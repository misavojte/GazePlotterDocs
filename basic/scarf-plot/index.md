...
The exported file can be then simply added to the workspace to already uploaded [SMI BeGaze](/upload-data/smi-begaze.md) data, see below.
...
The exported file can be then simply added to the workspace to already uploaded [Tobii Pro Lab](/upload-data/tobii-pro-lab.md) data, see below.
...
![Steps for adding dynamic AOI visibility data to the GazePlotter workspace](./aoi-visibility-1.png)
